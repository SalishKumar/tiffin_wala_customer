        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              if (widget.complain!.isResoved!) resolutionTileM(16.0),
              ...
              if (widget.complain!.isResoved!)
                widget.complain!.isCustomerRating!
                    ? const Text(
                        'Rating',
                        style: TextStyle(
                            color: Colors.black,
                    ...
                    : GestureDetector(
                        onTap: () async {
                          ...
                          // print("${widget.complain!.isResoved!} ${widget.complain!.isCustomerRating!}");
                        },
                        child: CustomButton(
                            width: width, title: "Rate Resolution")),
              if (widget.complain!.isResoved! &&
                  widget.complain!.isCustomerRating!)
                SizedBox(
                  height: 10,
                  ...
                  onPressed: () async {
                    if (rating != 0.0) {
                      Map<String, dynamic> map = {
                        "complain_id": widget.complain!.id,
                        "rating": rating,
                        "customer_id": widget.complain!.customerID
                      };
                      ...
                      dynamic result = await db.satisfactionRating(map);
                      Navigator.pop(context);
                      if (result == null) {
                        rating = 0.0;
                        ...
                        if (result != null) {
                          if (result['Timeout'] == 'true') {
                            ...
                            widget.complain!.rating = rating;
                            widget.complain!.isCustomerRating = true;
                            setState(() {});
